...
[create a proposal](https://github.com/zendframework/ZendXml/issues/new).
...
- Clone the repository:
  ...
  ```console
  $ git clone git://github.com/zendframework/ZendXml.git
  $ cd zendxml
  ```
...
2. Fork the repository (https://github.com/zendframework/ZendXml)
...
4. Add a remote to your fork; substitute your GitHub username in the command
   ...
   ```console
   $ git remote add {username} git@github.com:{username}/zendxml.git
   $ git fetch {username}
   ```
...
To ssh://git@github.com/{username}/zendxml.git
